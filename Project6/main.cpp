...
int main(void) {
	...
	printf("now the smallest is %d\n", minRec1(a, 10));
	printf("now the smallest is %d\n", minRec2(a, 10));
    int b[] = {4, 6, 9, 26, 100, 1, 2};
    printf("%d %d\n", minRec1(b, 7), minRec2(b, 7));
    ...
    printf("the sqrt of 3641 is %.15f\n", sqrtRec(3641, 0, 3641));
    ...
    Martian change5 = change(50);
    printf("change 5 should be 4d, 0n, 2p and is: %dd %dn %dp\n", change5.dodeks, change5.nicks, change5.pennies);

    Martian change6 = change(109);
    printf("change 6 should be 9d, 0n, 1p and is: %dd %dn %dp\n", change6.dodeks, change6.nicks, change6.pennies);

    Martian change7 = change(49);
    ...
    for(int cents = 0; cents < 51; cents++) {
        change1 = change(cents);
        int sum = change1.pennies + change1.nicks + change1.dodeks;
        printf("cents = %d\nbreakdown: %dd, %dn, %dp\nsum = %d\n\n", cents, change1.dodeks, change1.nicks, change1.pennies, sum);
    }
    ...
    printf("change 4 should be 0d, 2n, 1p and is: %dd %dn %dp\n", change4.dodeks, change4.nicks, change4.pennies);

    change4 = change(79, 12, 5);
    printf("change 4 should be 0d, 2n, 1p and is: %dd %dn %dp\n", change4.dodeks, change4.nicks, change4.pennies);

    change4 = change(79, 30, 17);
    printf("change 4 should be 0d, 2n, 1p and is: %dd %dn %dp\n", change4.dodeks, change4.nicks, change4.pennies);
